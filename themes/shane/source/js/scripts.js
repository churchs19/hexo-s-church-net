              ...
              beforeLoad: function() {
                if ($(this.element).hasClass("fancybox.html")) {
                  ...
                  this.content =
                    ...
                    this.href +
                    '"  poster="' +
                    $(this.element).attr("data-poster") +
                    '" width="' +
                    $(this.element).attr("data-width") +
                    '" height="' +
                    $(this.element).attr("data-height") +
